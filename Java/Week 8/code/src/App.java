...
public class App {
    ...
    public static void main(String[] args) {
        ...
        int[][] database = { { 194283, 1 }, { 328493, 1 }, { 342814, 1 }, { 481723, 2 }, { 491827, 2 }, { 581723, 1 },
                { 617234, 1 }, { 671263, 2 }, { 847124, 1 }, { 918294, 1 } };
        ...
        // add workers to different lists based on type
        for (int i = 0; i < newDatabase.length; i++) {
            if (newDatabase[i][1] == 1) {
